...
export const PROBLEMS: Problem[] = [{
  'id': 1,
  'name': 'Two Sum',
  'desc': 'Given an array of integers, find two numbers such that they add up to a ' +
...
},
  {
    ...
    'desc': 'Given an array S of n integers, are there elements a, b, c in ' +
      'S such that a + b + c = 0? Find all unique triplets in the array which gives ' +
      'the sum of zero.',
    'difficulty': 'medium'
  },
  {
    'id': 3,
    'name': '4Sum',
    'desc': 'Given an array S of n integers, are there elements a, b, c, and d ' +
      'in S such that a + b + c + d = target?\n\nFind all unique quadruplets in the' +
  ...
  },
  {
    'id': 4,
    'name': 'Triangle Count',
    'desc': 'Given an array of integers, how many three numbers can be found ' +
      'in the array, so that we can build an triangle whose three edges length is ' +
      'the three numbers that we find?',
    'difficulty': 'hard'},
  {
    'id': 5,
